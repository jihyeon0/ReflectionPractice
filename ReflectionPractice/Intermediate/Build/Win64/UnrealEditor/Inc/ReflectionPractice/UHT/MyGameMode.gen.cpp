...
#include "ReflectionPractice/Public/MyGameMode.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyGameMode() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_AGameMode();
REFLECTIONPRACTICE_API UClass* Z_Construct_UClass_AMyGameMode();
REFLECTIONPRACTICE_API UClass* Z_Construct_UClass_AMyGameMode_NoRegister();
...
template<> REFLECTIONPRACTICE_API UClass* StaticClass<AMyGameMode>()
{
	return AMyGameMode::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE_Projects_ReflectionPractice_Source_ReflectionPractice_Public_MyGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyGameMode, AMyGameMode::StaticClass, TEXT("AMyGameMode"), &Z_Registration_Info_UClass_AMyGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyGameMode), 167806302U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_ReflectionPractice_Source_ReflectionPractice_Public_MyGameMode_h_2580983601(TEXT("/Script/ReflectionPractice"),
	Z_CompiledInDeferFile_FID_UE_Projects_ReflectionPractice_Source_ReflectionPractice_Public_MyGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_ReflectionPractice_Source_ReflectionPractice_Public_MyGameMode_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
